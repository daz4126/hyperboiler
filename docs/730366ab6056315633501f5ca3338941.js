...
exports.List = exports.AddItem = exports.ListItem = undefined;
...
var AddItem = exports.AddItem = function AddItem(_ref2) {
  var add = _ref2.add,
      input = _ref2.input,
      value = _ref2.value,
...
var List = exports.List = function List(_ref3) {
  var items = _ref3.items,
      toggle = _ref3.toggle,
...
},{"hyperapp":11}],6:[function(require,module,exports) {
'use strict';
...
var view = function view(state, actions) {
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(_components.AddItem, { add: actions.add, input: actions.input,
      value: state.input, placeholder: state.placeholder }),
    (0, _hyperapp.h)(_components.List, { items: state.items, toggle: actions.toggle, destroy: actions.destroy }),
    (0, _hyperapp.h)(
      'a',
...
},{"hyperapp":11,"./components.js":9}],2:[function(require,module,exports) {
'use strict';
...
},{"./css/index.scss":3,"hyperapp":11,"./js/actions.js":4,"./js/state.js":5,"./js/view.js":6}],12:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '60649' + '/');
